...
let projects = [
  {
    image: 'textures/image.png',
    url: '',
  },
  {
    image: 'textures/image copy 2.png',
    url: '',
  },
  {
    image: 'textures/image copy 3.png',
    url: '',
  },
  {
    image: 'textures/image copy 4.png',
    url: '',
  },
  {
    image: 'textures/image copy 5.png',
    url: '',
  },

  {
    image: 'textures/image copy 6.png',
    url: '',
  },

  {
    image: 'textures/image copy.png',
    url: '',
  },


  {
    image: 'textures/image copy 7.png',
    url: '',
  },
...
function projectsMenuListener() {
  ...
  const rowIndex = Math.floor(i / 3);
    ...
    // Main card geometry
    const cardGeometry = new THREE.PlaneGeometry(0.78, 0.4);
    ...
    // Border geometry
    const borderGeometry = new THREE.PlaneGeometry(2 + borderWidth, 2 + borderWidth);
    ...
    cardGroup.add(borderPlane);
    cardGroup.add(cardPlane);

    cardPlane.position.set(0, 0, 0.01); // Slightly above the border
  ...
  document
    ...
    .addEventListener('click', function (e) {
      ...
      projects.forEach((project, i) => {
        ...
        gsap.to(project.mesh.children[1].material, { // Target the card material
          opacity: 1,
          duration: 1.5,
          delay: 1.5 + i * 0.1,
        });
